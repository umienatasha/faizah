...
<!DOCTYPE html>
    ...
    <body>
        ...
        <!--========== CONTENTS ==========-->
		 ...
		 <div class="container">
		 <center><h2>U P D A T E . P A T I E N T . M A N A G E M E N T</h2></center>
		 <br>
		 <br>
			  <form method="post" action="updatepatient.php">
				...
				<div class="row">
				  <div class="col-25">
					<label><strong>Identity Card</strong></label>
				  </div>
				  <div class="col-75">
					<input type="number" name="ic" value="<?php echo $row["ic"];?>" required  required />
				  </div>
				</div>
				<br>
