			...
			<br>
			  <table>
				...
				<tr>
					...
					<td><?php
							$med_id=$row["id_category"];
							
								$sql = "SELECT category.id_category, category.category FROM category, tbl_rawatan WHERE category.id_category=tbl_rawatan.id_rawatan and tbl_rawatan.id_category='$med_id'";
								$result = mysqli_query($conn, $sql);
					...
					<td>											
						<button><a href="updatetreat.php?id=<?php echo $row["id_rawatan"]; ?>" class="btn btn-danger delete-listview-btn" onClick="return confirm">Update</a></button>
						<button><a href="deletetreat.php?id=<?php echo $row["id_rawatan"]; ?>" class="btn btn-danger delete-listview-btn" onClick="return confirm('Do you really want to delete?');">Delete</a></button>
					</td>
				</tr>
