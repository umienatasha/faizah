...
<!DOCTYPE html>
    ...
    <body>
        ...
        <main>
           <div class="container">   
		   <center><h2>A D D . T R E A T M E N T</h2></center>
		   <BR>
			  <form method="post" action="regrawatan.php">
				...
				<div class="row">
				  ...
				  <div class="col-75">
					<input type="text" name="rawatan_nama" placeholder="Treatment Name" required />
				  </div>
				</div>
				<br>
				...
				<div class="row">
				  ...
				  <div class="col-75">
					<input type="text" name="rawatan_harga" value="RM " required />
				  </div>
				</div>
				<br>
