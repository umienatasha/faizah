...
$dis_usr="SELECT * FROM tbl_rawatan WHERE id_rawatan='$idusr'";
...
<!DOCTYPE html>
    ...
    <head>
		...
		* {
        ...
        <title>U P D A T E . T R E A T M E N T</title>
    ...
    <body>
        ...
        <main>
           <div class="container">
		   <center><h2>U P D A T E . T R E A T M E N T</h2></center>
		   <BR>
			  <form method="post" action="updateprotreat.php">
				...
				<div class="row">
				  ...
				  <div class="col-75">
					<input type="text" name="rawatan_nama" value="<?php echo $row["rawatan_nama"];?>" required  />
				  </div>
				</div>
					
				<div class="row">
				  <div class="col-25">
					<label><strong>Treatment Price</strong></label>
				  </div>
				  <div class="col-75">
					<input type="text" name="rawatan_harga" value="<?php echo $row["rawatan_harga"];?>" required />
				  </div>
				</div>
				<BR>
				...
				<div class="row">
				  ...
				  <input type="hidden" name="id" value="<?php echo $row["id_rawatan"]; ?>"/>
				</div>
			  </form>
			</div>
        </main>
