...
<!DOCTYPE html>
    ...
    <body>
        ...
        <main>
			...
			<center><h2>C A T E G O R Y</h2></center>
			<br>
			  <table>
				<tr>
					<th>No.</th>
				...
				<tr>
				  ...
				  <td>
					<button><a href="#.php?id=<?php echo $row["id_category"]; ?>" class="btn btn-danger delete-listview-btn" onClick="return confirm">Update</a></button>
					<button><a href="deletepatient.php?id=<?php echo $row["id_category"]; ?>" class="btn btn-danger delete-listview-btn" onClick="return confirm('Do you really want to delete?');">Delete</a></button>			
				  </td>
				</tr>
