...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>U P D A T E . H O L I D A Y</title>
		<style>
		* {
    ...
    <body>
        ...
        <main>
           <div class="container">
		   <center><h2>U P D A T E . P U B L I C . H O L I D A Y</h2></center>
		   <BR>
			  <form method="post" action="updateprocuti.php">
				...
				<div class="row">
				  ...
				  <div class="col-75">
					<input type="date" name="tarikh" value="<?php echo $row["tarikh"];?>" required  />
				  </div>
				</div>
				<br>
				...
				<div class="row">
				  ...
				  <div class="col-75">
					<input type="text" name="sebab" value="<?php echo $row["sebab"];?>" required />
				  </div>
				</div>
				<BR>
