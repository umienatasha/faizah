...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `bookings` WHERE CONCAT(`name`, `ic`) LIKE '%".$valueToSearch."%'";
...
<!DOCTYPE html>
    ...
    <body>
		...
		<div class="header__search">
			<input class="header__input" type="text" class="form-control" id="domainnamehere" name="valueToSearch" placeholder="Patient Name or Identity Card">
			<button type="submit" name="search" value="Filter" class="btn btn-primary grd1"><i class='bx bx-search header__icon' ></i></button>
			
		</div>
		
            <div style="overflow-x: auto;">
			<center><h2>D E T A I L . A P P O I N T M E N T</h2></center>
			<br>
